  ...
  return (
    <>
      ...
      <div className="bg-stone-50 text-zinc-700 overflow-hidden">
        <div className="bg-white  mt-28 h-auto md:h-[90vh] max-w-4xl mx-auto flex flex-col md:flex-row items-center rounded-lg">
          {/* left Hi there */}
          <div className="md:pl-20 py-20 h-auto md:h-full flex flex-col justify-center gap-5 w-full md:w-3/5 text-center md:text-left">
            <p className="animate__animated animate__fadeInDown uppercase">
              Welcome to my world
            </p>
            ...
            <p className="animate__animated animate__fadeInDown animate__delay-1s text-xl md:text-3xl md:mb-7">
              Based in Japan
            </p>
          ...
          {/* Right Picture */}
          <div className="animate__animated animate__fadeIn animate__delay-1s animate__slow	3s w-1/2 md:w-2/5 md:pr-20 ">
            <Image
              src={profilePic}
              alt="Profile Picture"
