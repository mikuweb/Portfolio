...
const Contact = () => {
  return (
    <>
      <div
        id="about"
        className="border-2 bg-sky-50 text-slate-600 md:h-fit w-full mx-auto flex flex-col items-center text-center overflow-hidden"
      >
        ...
        <div className="flex flex-col gap-2 md:text-lg">
          <p>
            ...
            I'm actively seeking new opportunities <br className="md:hidden" />as a front-end web developer,
            <br />
        ...
        {/* Email Button */}
        <button className="border-2 text-lg md:text-2xl font-semibold w-52 md:w-60 py-3 mx-auto rounded-lg">
          Contact Me
        </button>
        </div>
      </div>
