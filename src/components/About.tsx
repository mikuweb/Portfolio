...
const About = () => {
  return (
    <>
      ...
      <div
        id="about"
        className="bg-stone-50 border-2 text-zinc-700 md:h-fit mx-auto flex flex-col items-center relative overflow-hidden"
      >
        <h2 className="font-bold text-5xl p-14 ">About Me</h2>
        {/* White container */}
        <div className="border-2 bg-white h-auto max-w-4xl mx-auto flex flex-col md:flex-row items-center md:rounded-lg md:mb-14">
          {/* Left Picture */}
